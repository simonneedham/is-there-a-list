    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    ...
                    {
                        return View("LoginNotAuthorised");
                    }
                }
                else
                {
        ...
        public async Task<ActionResult> ExternalLoginCallback(string returnUrl)
        {
            ...
            else
            {
                ...
                {
                    EditableObject = new ApplicationUser()
                            {
                                FirstName = addtionalDetail.FirstName,
                                LastName = addtionalDetail.LastName,
                                EmailAddress = addtionalDetail.EmailAddress,
                                DobDay = addtionalDetail.DobDay,
                                DobMonth = addtionalDetail.DobMonth
                            },
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalRegisterViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //Test to see if an email address has already been registered
                var userExists = await UserManager.FindByNameAsync(user.UserName);
                if(userExists != null)
                {
                    ModelState.AddModelError("EditableObject.EmailAddress", "A user with this email address already exists.");
                }
        ...
        public ActionResult LogOff()
        {
            ...
            this.Session.Store<ApplicationUser>("currentUser", null);
        ...
        private async Task SignInAsync(ApplicationUser user, bool isPersistent)
        {
            ...
            this.Session.Store<ApplicationUser>("currentUser", clone);
        }
